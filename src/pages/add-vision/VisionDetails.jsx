...
const VisionDetails = () => {
    ...
    const fetchMissionDetails = async () => {
      try {
        ...
        setMissionData(res.data.vision); // Ensure this matches your API response structure
      } catch (err) {
        console.error("Error fetching vision details:", err);
        setError("Failed to load vision details.");
      } finally {
        setLoading(false);
      }
    };
              ...
              <div className="p-3">
                ...
                <div className="overflow-x-auto">
                  <div className="flex justify-center mb-8">
                    <img
                      src={`http://localhost:5000/vision/${missionData.image}`}
