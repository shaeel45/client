...
const UserDetails = () => {
    ...
    const fetchMissionDetails = async () => {
      try {
        ...
        setMissionData(res.data.user); // Ensure this matches your API response structure
      } catch (err) {
          ...
          <div className="col-span-full xl:col-span-8 bg-white dark:bg-gray-900 shadow-sm rounded-xl">
            ...
            <div className="p-3">
              ...
              <div className="overflow-x-auto">
                ...
                <p className="pt-5">{missionData.name}</p>
                ...
                <h1 className="text-4xl pt-10">Password</h1>
                <div className="pt-5">
                  <p>
                      {missionData.password}
                  </p>
                </div>
              </div>
            </div>
