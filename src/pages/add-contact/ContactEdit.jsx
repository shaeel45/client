...
const ContactEdit = () => {
    ...
    const fetchMission = async () => {
      try {
        ...
        const { emailHeading, email, emailImage } = res.data.mission;
        setFormData({ emailHeading, email, emailImage });
      } catch (error) {
    ...
    const handleSubmit = async (e) => {
      ...
      formDataToSend.append("emailHeading", formData.emailHeading);
      formDataToSend.append("email", formData.email);
  
      if (formData.emailImage) {
        formDataToSend.append("emailImage", formData.emailImage); // Include the new image
      }
