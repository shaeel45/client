                      ...
                      {[1, 2].map((item) => (
                        <tr key={item}>
                          ...
                          <td className="p-2 w-3/5">
                            <div>
                              {"Tailored web solutions that meet unique business needs, ensuring scalability, flexibility, and optimal performance for future growth."
                                .split(" ")
                                .slice(0, 10)
                                .join(" ")}
                              {` .....`}
